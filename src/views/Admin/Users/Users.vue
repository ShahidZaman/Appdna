                ...
                <template v-if="!user?.deleted">
                  <td>
                    ...
                    <div v-if="user.id === editId" class="add-user-form edit-user-form ">
                      <form>
                        <input v-model="selectedUser" type="text" placeholder="" required form="edit-form" class="user-name"/>
                      </form>
                    </div>
                  </td>
                  <td>
                    ...
                    <div v-if="user.id === editId" class="add-user-form edit-user-form">
                      <form @submit.prevent="onUpdateUser(user.id)" id="edit-form">
                        <input v-model="selectedEmail" type="email" placeholder="Email address" required/>
                        <div class="buttons">
...
const fakeusers =[
    {
        "id": "c1e67b8c-3ec5-4eee-b5f4-90b38ba23d30",
        "userName": "admin",
        "dateJoined": "2024-02-16T07:37:46.480081Z",
        "email": "",
    ...
    {
        "id": "3018f4b5-fc90-438d-80b6-d1e75453a929",
        "userName": "test",
        "dateJoined": "2024-02-19T08:18:21.632324Z",
        "email": "test@mail.com",
        "emailConfirmed": false,
        "tfaEnabled": false,
        "deleted": false
